        ...
        <div className="flex flex-col h-full bg-[#1a2035]">
            ...
            <div className="relative">
                ...
                <div className="bg-[#1f283e] rounded-md shadow-2xl relative pt-10 pb-6 w-full">
                    ...
                    <div
                        className="absolute -top-6 left-5 rounded-md px-8 py-5 z-10"
                        style={{
                        ...
                        <form onSubmit={handleSubmit} autoComplete="off">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                ...
                                <div className="space-y-1">
                                    <label className="block text-slate-400 text-[13px] font-medium uppercase tracking-wide">
                                    ...
                                    />
                                    {errors.newPassword && (
                                        <p className="text-red-400 text-[12px] mt-1">{errors.newPassword}</p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    {errors.confirmPassword && (
                                        <p className="text-red-400 text-[12px] mt-1">{errors.confirmPassword}</p>
                                    )}
                                </div>
                            </div>
